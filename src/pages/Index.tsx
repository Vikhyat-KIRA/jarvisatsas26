          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="rounded-xl border border-destructive/20 p-6 bg-destructive/[0.03]">
              ...
              <div className="space-y-2">
                {["12V Li-ion Battery — lowest chassis point", "{["12V Li-ion Battery — lowest chassis point", "2200μF Capacitor — brownout absorption", "L298N Motor Driver — VIN 5–35V", "2× BO Motors — drive wheels"].map((t) => (", "L298N Motor Driver — VIN 5–35V", "2× BO Motors — drive wheels"].map((t) => (
